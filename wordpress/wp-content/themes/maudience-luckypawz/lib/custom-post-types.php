...
*/
	 ...
	 **/
		...
		add_action( 'init', ma_custom_post_type_creator('Staff', 'Holds our staff specific data', true, 7, array( 'title', 'editor', 'thumbnail' ), true, false, 'staff'));
		add_action( 'init', ma_custom_post_type_creator('Services', 'Holds our data about our services', true, 7, array( 'title', 'editor', 'thumbnail' ), true, false, 'services'));
